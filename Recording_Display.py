...
def update(scrn,board):
    '''
    updated the screen basis the board class
    '''
...
def save_main_two_agent(BOARD,agent1,agent_color1,agent2):
    '''
    ...
    while (status):
        #update screen
        update(scrn,BOARD)
        pygame.image.save(scrn,"saves/frame"+str(frame)+".jpg")
        frame += 1
